...
//Funtions
function buscar(){
    const terminoBusqueda = textoBusqueda.value;
    // console.log(textoBusqueda.value);
    if (terminoBusqueda !== "") {
        console.log("Entro a la función buscar");
        console.log("El usuario está buscando:", terminoBusqueda);
        const resultado = piezas.find(pieza => pieza.nombre.toLocaleLowerCase() == terminoBusqueda.toLocaleLowerCase());
